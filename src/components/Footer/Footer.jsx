import {sections} from "../../../public/data/footer"
...
export default function Footer() {
    return (
        <footer className="">
            <div className='mt-4 mb-4 opacity-20'>
                <div className='h-[1px] w-auto bg-black mb-[2px]'></div>
                <div className='h-[1px] w-auto bg-black'></div>
            </div>

            <div className="p-4">
                <svg className="css-oylsik w-[200px] " viewBox="0 0 184 25" fill="#000" aria-hidden="true" aria-label='Logo'>
                ...
                <div className="flex sm:flex-row flex-col justify-between mt-8">                   
                    {sections.map((section, i) => (
                        <div key={i} className="text-left flex flex-col">
                            <h4 className="text-sm font-bold mb-2 mt-2 sm:mt-0">{section.title}</h4>
                            <div className="sm:hidden h-[1px] bg-gray-200"></div>
                            {section.sections.map((subsection, j) => (
                                <p className="hidden sm:block text-[13px] mb-1" key={j}>{subsection}</p>
                            ))}                                                              
                        </div>
                    ))}                                         
                    <div className="hidden sm:flex">
                        <div className="w-[1px] bg-black opacity-35 mr-4"></div>
                        <div>
                           <a><h4 className="text-sm font-bold mb-2">ACCOUNT</h4></a>
                            <a>
                                <p className="font-bold text-[15px] mb-1 flex items-center">
                                    <CgProfile className="mr-2"/> Subscribe
                                </p>
                            </a>
                            <a>
                                <p className="font-bold text-[15px] mb-1 flex items-center">
                                    <BiSolidUserAccount className="mr-2"/>Manage My account
                                </p>
                            </a>
                            <a>
                                <p className="font-bold text-[15px] mb-1 flex items-center">
                                    <MdAccountBalanceWallet className="mr-2"/>Home Delivery
                                </p>
                            </a>
                        </div>                      
                    </div>
            ...
            <div className='h-[1px] w-auto bg-black opacity-20 dark:opacity-100 dark:bg-white'></div>
            <div className=" text-gray-500 dark:text-white text-center p-4 flex flex-col sm:flex-row justify-between">             
                <div className="sm:hidden mb-2">
                    <p className="text-[10px] ">© 2024 The New York Times Company</p>
                </div>

                <p className="text-[10px] hidden sm:block">© 2024 The New York Times Company</p>
                <div className="flex flex-wrap justify-between ">
                    <p className="text-[10px]">NYTCo</p>
                    <p className="text-[10px]">Contact Us</p>
                    <p className="text-[10px]">Accessibility</p>
                    <p className="text-[10px]">Work with us</p>
                    <p className="text-[10px]">Advertise</p>
                    <p className="text-[10px]">T Brand Studio</p>
                    <p className="text-[10px]">Your Ad choices</p>
